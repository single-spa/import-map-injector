...
import-map-injector is compatible with [import-map-overrides](https://github.com/single-spa/import-map-overrides) via an in-code integration. To use the two projects together, do the following:
